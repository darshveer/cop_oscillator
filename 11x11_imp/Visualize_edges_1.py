...
def parse_enables(enable_file):
    ...
    with open(enable_file, "r") as f:
        for line in f:
            ...
            # V_EN_C_r1_c1__r2_c2 EN_C_r1_c1__r2_c2 gnd 1
...
# and SAVE the image instead of showing it.
# -------------------------------------------------------------------
def draw_network(ro_positions, edges, ro_enable, c_enable, signum_map, output_file):
    ...
    # Save and close (no interactive window)
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("Usage:")
        print("   python Visualize_edges.py <enable_file.sp> <network_file.sp> <signum_output.csv> <output_image_path>")
        sys.exit(1)
    ...
    draw_network(ro_positions, edges, ro_enable, c_enable, signum_map, output_image_path)
